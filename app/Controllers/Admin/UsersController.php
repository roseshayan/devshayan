...
final class UsersController extends BaseAdminController
{
    public function index(): string
    {
        ...
        $this->guardAdmin();
        $pdo = Database::pdo();
        $rows = $pdo->query("SELECT id,name,email,role,created_at FROM users ORDER BY id ASC")->fetchAll();
        return View::render('admin/users', ['title' => 'Users', 'users' => $rows], 'admin/layout');
    }
